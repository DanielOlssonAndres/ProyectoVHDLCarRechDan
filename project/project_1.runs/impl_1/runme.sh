...
HD_PWD='C:/Users/marco/OneDrive/Documentos/GitHub/ProyectoVHDLCarRechDan/project/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log GenSecuencia.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source GenSecuencia.tcl -notrace
