...
-- Date        : Fri Dec 13 09:59:34 2024
-- Host        : PortatilMarcos running 64-bit major release  (build 9200)
-- Command     : write_vhdl -mode funcsim -nolib -force -file
--               C:/Users/marco/OneDrive/Documentos/GitHub/ProyectoVHDLCarRechDan/project/project_1.sim/sim_1/synth/func/xsim/comprobar_all_tb_func_synth.vhd
-- Design      : TOP
...
entity CompSecuencia is
  port (
    ...
    \sec_generada_s_reg[8][1]\ : out STD_LOGIC;
    ...
    \sec_generada_s_reg[2][1]_1\ : out STD_LOGIC;
    \sec_generada_s_reg[6][2]\ : out STD_LOGIC;
    \sec_generada_s_reg[2][1]_2\ : out STD_LOGIC;
    \sec_generada_s_reg[6][2]_0\ : out STD_LOGIC;
    ...
    \sec_generada[6]\ : in STD_LOGIC_VECTOR ( 1 downto 0 );
    ...
    \estado_actual_reg[0]\ : in STD_LOGIC_VECTOR ( 1 downto 0 );
    \estado_actual_reg[0]_0\ : in STD_LOGIC;
    ...
    error_prev_i_2 : in STD_LOGIC;
    exito_prev_i_2 : in STD_LOGIC;
    exito_prev_i_2_0 : in STD_LOGIC;
    exito_prev_i_2_1 : in STD_LOGIC;
    \i_reg[3]_i_4_0\ : in STD_LOGIC;
    \i_reg[3]_i_4_1\ : in STD_LOGIC;
    \i_reg[3]_i_4_2\ : in STD_LOGIC;
    \sec_actual_reg[1][1]_i_9\ : in STD_LOGIC_VECTOR ( 1 downto 0 );
    \sec_actual_reg[1][1]_i_14\ : in STD_LOGIC_VECTOR ( 1 downto 0 );
...
architecture STRUCTURE of CompSecuencia is
  ...
  signal \sec_actual_reg[1][1]_i_11_n_0\ : STD_LOGIC;
  ...
  signal \sec_actual_reg_n_0_[6][1]\ : STD_LOGIC;
  signal \sec_actual_reg_n_0_[6][2]\ : STD_LOGIC;
  signal \sec_actual_reg_n_0_[7][0]\ : STD_LOGIC;
  signal \^sec_generada_s_reg[1][2]\ : STD_LOGIC;
  signal \^sec_generada_s_reg[2][1]\ : STD_LOGIC;
  signal \^sec_generada_s_reg[2][1]_0\ : STD_LOGIC;
  signal \^sec_generada_s_reg[2][1]_2\ : STD_LOGIC;
  signal \^sec_generada_s_reg[8][1]\ : STD_LOGIC;
  signal NLW_i0_carry_CO_UNCONNECTED : STD_LOGIC_VECTOR ( 3 downto 2 );
  signal NLW_i0_carry_O_UNCONNECTED : STD_LOGIC_VECTOR ( 3 to 3 );
  ...
  attribute SOFT_HLUTNM of \i_reg[0]_i_1\ : label is "soft_lutpair1";
  ...
  attribute SOFT_HLUTNM of \i_reg[2]_i_1\ : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of \i_reg[3]_i_11\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \i_reg[3]_i_13\ : label is "soft_lutpair0";
  ...
  attribute XILINX_LEGACY_PRIM of \sec_actual_reg[6][2]\ : label is "LD";
  attribute XILINX_TRANSFORM_PINMAP of \sec_actual_reg[6][2]\ : label is "VCC:GE GND:CLR";
  ...
  attribute XILINX_LEGACY_PRIM of \sec_actual_reg[8][1]\ : label is "LD";
  attribute XILINX_TRANSFORM_PINMAP of \sec_actual_reg[8][1]\ : label is "VCC:GE GND:CLR";
...
begin
  ...
  \sec_generada_s_reg[1][2]\ <= \^sec_generada_s_reg[1][2]\;
  \sec_generada_s_reg[2][1]\ <= \^sec_generada_s_reg[2][1]\;
  \sec_generada_s_reg[2][1]_0\ <= \^sec_generada_s_reg[2][1]_0\;
  \sec_generada_s_reg[2][1]_2\ <= \^sec_generada_s_reg[2][1]_2\;
  \sec_generada_s_reg[8][1]\ <= \^sec_generada_s_reg[8][1]\;
\estado_actual[2]_i_2\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => \^sync_out_reg\,
      I2 => \^sync_out_reg_0\,
      I3 => \estado_actual_reg[0]\(0),
      I4 => \estado_actual_reg[0]\(1),
      I5 => \estado_actual_reg[0]_0\,
      O => error_prev_reg
    );
...
i0_carry: unisim.vcomponents.CARRY4
     port map (
      CI => '0',
      CO(3 downto 2) => NLW_i0_carry_CO_UNCONNECTED(3 downto 2),
      CO(1) => i0_carry_n_2,
      CO(0) => i0_carry_n_3,
      CYINIT => \^q\(0),
      DI(3 downto 0) => B"0000",
      O(3) => NLW_i0_carry_O_UNCONNECTED(3),
...
\i_reg[3]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"AAAAAAAB"
    )
        port map (
...
\i_reg[3]_i_4\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000088881124"
    )
        port map (
      I0 => error_prev_i_2,
      I1 => \^sec_generada_s_reg[2][1]_0\,
      I2 => boton_listo_2,
      I3 => boton_listo_1,
      I4 => boton_listo_0,
      I5 => \i_reg[3]_i_8_n_0\,
...
\i_reg[3]_i_7\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"2020202F2F2F202F"
    )
        port map (
...
\i_reg[3]_i_8\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"BABF4540"
    )
        port map (
...
\sec_actual_reg[1][1]_i_10\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
      I0 => \^sec_generada_s_reg[8][1]\,
      I1 => \sec_generada[8]\(0),
      O => \sec_actual_reg[1][1]_i_10_n_0\
    );
\sec_actual_reg[1][1]_i_11\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
      I0 => \^sec_generada_s_reg[1][2]\,
      I1 => \sec_generada[1]\(2),
      O => \sec_actual_reg[1][1]_i_11_n_0\
    );
...
\sec_actual_reg[1][1]_i_13\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9009000000009009"
    )
        port map (
...
\sec_actual_reg[1][1]_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9009000000009009"
        ...
        port map (
      I0 => \sec_actual_reg_n_0_[6][2]\,
      I1 => \sec_generada[6]\(1),
      I2 => \sec_generada[6]\(0),
      I3 => \sec_actual_reg_n_0_[6][1]\,
      I4 => \sec_generada[1]\(2),
      I5 => \^sec_generada_s_reg[1][2]\,
      O => \sec_generada_s_reg[6][2]_0\
    );
\sec_actual_reg[1][1]_i_6\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFF7DFFFFFFFFFF"
    )
        port map (
      I0 => \^sec_generada_s_reg[2][1]_2\,
      I1 => \sec_generada[6]\(1),
      I2 => \sec_actual_reg_n_0_[6][2]\,
      I3 => \sec_actual_reg[1][1]_i_10_n_0\,
      I4 => \sec_actual_reg[1][1]_i_11_n_0\,
      I5 => \sec_actual_reg[1][1]_i_12_n_0\,
      O => \sec_generada_s_reg[6][2]\
    );
\sec_actual_reg[1][1]_i_8\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
      I0 => \^sec_generada_s_reg[2][1]\,
      I1 => \sec_generada[2]\(1),
      O => \^sec_generada_s_reg[2][1]_2\
    );
...
\sec_actual_reg[6][1]\: unisim.vcomponents.LDCE
    generic map(
      ...
      G => E(0),
      GE => '1',
      Q => \sec_actual_reg_n_0_[6][1]\
    );
\sec_actual_reg[6][2]\: unisim.vcomponents.LDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\sec_actual_reg[8][1]\: unisim.vcomponents.LDCE
    generic map(
      INIT => '0'
    )
        port map (
...
entity Controlador_de_Sec is
  port (
    ...
    \led_reg[3]\ : in STD_LOGIC;
    \sec_generada[1]\ : in STD_LOGIC_VECTOR ( 0 to 0 );
    \sec_generada[7]\ : in STD_LOGIC_VECTOR ( 0 to 0 );
    \led_reg[3]_0\ : in STD_LOGIC;
    \led_reg[3]_1\ : in STD_LOGIC;
    \sec_generada[5]\ : in STD_LOGIC_VECTOR ( 2 downto 0 );
    fin_detectado_reg_i_3_0 : in STD_LOGIC_VECTOR ( 1 downto 0 );
    \sec_generada[6]\ : in STD_LOGIC_VECTOR ( 0 to 0 );
    \sec_generada[8]\ : in STD_LOGIC_VECTOR ( 0 to 0 );
    \sec_generada[2]\ : in STD_LOGIC_VECTOR ( 0 to 0 );
    RESET_IBUF : in STD_LOGIC;
    \p_0_in__0\ : in STD_LOGIC_VECTOR ( 0 to 0 );
    \indice_reg[3]_0\ : in STD_LOGIC;
...
architecture STRUCTURE of Controlador_de_Sec is
  ...
  signal fin_detectado_reg_i_13_n_0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of error_prev_i_2 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \estado_actual[2]_i_3\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of exito_prev_i_1 : label is "soft_lutpair5";
  attribute XILINX_LEGACY_PRIM : string;
  ...
  attribute SOFT_HLUTNM of fin_detectado_reg_i_1 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of fin_detectado_reg_i_2 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \i_reg[3]_i_5\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \led[1]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \led[2]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \led[3]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \led[4]_i_1\ : label is "soft_lutpair6";
...
fin_detectado_reg_i_13: unisim.vcomponents.LUT5
    generic map(
      INIT => X"E2000000"
    )
        port map (
...
fin_detectado_reg_i_16: unisim.vcomponents.LUT5
    generic map(
      INIT => X"E2000000"
    )
        port map (
...
fin_detectado_reg_i_3: unisim.vcomponents.LUT5
    generic map(
      INIT => X"8888BB8B"
    )
        port map (
...
fin_detectado_reg_i_8: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => \sec_generada[5]\(1),
      I3 => \^indice_reg\(0),
      I4 => fin_detectado_reg_i_3_0(1),
      I5 => fin_detectado_reg_i_16_n_0,
      O => fin_detectado_reg_i_8_n_0
    );
\i_reg[3]_i_5\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
...
\led[4]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"20000000"
    )
        port map (
...
architecture STRUCTURE of DivisorReloj is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \contador[2]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \contador[3]_i_1\ : label is "soft_lutpair8";
begin
  AR(0) <= \^ar\(0);
  \^clk\ <= \^clk_1\;
...
entity GenSecuencia is
  port (
    ...
    \sec_generada[6]\ : out STD_LOGIC_VECTOR ( 1 downto 0 );
    \sec_generada[7]\ : out STD_LOGIC_VECTOR ( 0 to 0 );
    \sec_generada[9]\ : out STD_LOGIC_VECTOR ( 0 to 0 );
    sec_lista : out STD_LOGIC;
    \sec_generada[8]\ : out STD_LOGIC_VECTOR ( 0 to 0 );
    ...
    \sec_generada_s_reg[4][1]_0\ : out STD_LOGIC_VECTOR ( 1 downto 0 );
    \sec_generada_s_reg[3][1]_0\ : out STD_LOGIC;
    \sec_generada_s_reg[3][1]_1\ : out STD_LOGIC_VECTOR ( 1 downto 0 );
    \sec_generada_s_reg[0][1]_0\ : out STD_LOGIC_VECTOR ( 1 downto 0 );
    \sec_generada_s_reg[8][1]_0\ : out STD_LOGIC;
    \sec_generada_s_reg[7][0]_0\ : out STD_LOGIC;
    \sec_generada_s_reg[5][1]_0\ : out STD_LOGIC;
    \sec_generada_s_reg[2][1]_0\ : out STD_LOGIC;
    indice_reg_2_sp_1 : out STD_LOGIC;
    indice_reg_1_sp_1 : out STD_LOGIC;
    \sec_generada_s_reg[3][1]_2\ : out STD_LOGIC;
    \sec_generada_s_reg[3][0]_0\ : out STD_LOGIC;
    E : out STD_LOGIC_VECTOR ( 0 to 0 );
    \sec_generada_s_reg[2][1]_1\ : out STD_LOGIC;
    \sec_generada_s_reg[8][1]_1\ : in STD_LOGIC;
    \sec_generada_s_reg[5][0]_0\ : in STD_LOGIC;
    clk_BUFG : in STD_LOGIC;
    D : in STD_LOGIC_VECTOR ( 3 downto 0 );
    \sec_generada_s_reg[9][1]_0\ : in STD_LOGIC;
    \sec_generada_s_reg[6][2]_0\ : in STD_LOGIC;
    \sec_generada_s_reg[1][2]_0\ : in STD_LOGIC;
    \sec_generada_s_reg[5][1]_1\ : in STD_LOGIC;
    \sec_generada_s_reg[5][2]_1\ : in STD_LOGIC;
    \sec_generada_s_reg[2][1]_2\ : in STD_LOGIC;
    Q : in STD_LOGIC_VECTOR ( 3 downto 0 );
    \i_reg[3]_i_4\ : in STD_LOGIC;
    indice_reg : in STD_LOGIC_VECTOR ( 3 downto 0 );
    \i_reg[3]_i_2\ : in STD_LOGIC;
    \i_reg[3]_i_2_0\ : in STD_LOGIC;
    \sec_actual_reg[1][1]_i_1_0\ : in STD_LOGIC_VECTOR ( 1 downto 0 );
    \sec_actual_reg[1][1]_i_1_1\ : in STD_LOGIC;
    \sec_actual_reg[1][1]_i_2_0\ : in STD_LOGIC_VECTOR ( 1 downto 0 );
    \sec_actual_reg[1][1]_i_1_2\ : in STD_LOGIC;
    \sec_actual_reg[1][1]_i_1_3\ : in STD_LOGIC;
    \sec_actual_reg[1][1]_i_1_4\ : in STD_LOGIC;
    \sec_actual_reg[1][1]_i_1_5\ : in STD_LOGIC;
    \sec_actual_reg[1][1]_i_1_6\ : in STD_LOGIC_VECTOR ( 1 downto 0 );
    \sec_actual_reg[1][1]_i_1_7\ : in STD_LOGIC;
    \sec_actual_reg[1][1]_i_7_0\ : in STD_LOGIC_VECTOR ( 1 downto 0 );
    \sec_actual_reg[1][1]_i_1_8\ : in STD_LOGIC_VECTOR ( 1 downto 0 );
    ...
    \sec_generada_s_reg[3][1]_3\ : in STD_LOGIC_VECTOR ( 1 downto 0 );
    \sec_generada_s_reg[4][1]_1\ : in STD_LOGIC_VECTOR ( 1 downto 0 )
  );
end GenSecuencia;
...
architecture STRUCTURE of GenSecuencia is
  ...
  signal indice_reg_1_sn_1 : STD_LOGIC;
  signal indice_reg_2_sn_1 : STD_LOGIC;
  signal \sec_actual_reg[1][1]_i_14_n_0\ : STD_LOGIC;
  ...
  signal \sec_actual_reg[1][1]_i_9_n_0\ : STD_LOGIC;
  ...
  signal \^sec_generada[6]\ : STD_LOGIC_VECTOR ( 1 downto 0 );
  signal \^sec_generada[7]\ : STD_LOGIC_VECTOR ( 0 to 0 );
  signal \^sec_generada[8]\ : STD_LOGIC_VECTOR ( 0 to 0 );
  signal \^sec_generada[9]\ : STD_LOGIC_VECTOR ( 0 to 0 );
  signal \^sec_generada_s_reg[0][1]_0\ : STD_LOGIC_VECTOR ( 1 downto 0 );
  signal \^sec_generada_s_reg[2][1]_0\ : STD_LOGIC;
  signal \^sec_generada_s_reg[3][1]_1\ : STD_LOGIC_VECTOR ( 1 downto 0 );
  signal \^sec_generada_s_reg[4][1]_0\ : STD_LOGIC_VECTOR ( 1 downto 0 );
  signal \^sec_generada_s_reg[5][1]_0\ : STD_LOGIC;
  signal \^sec_generada_s_reg[7][0]_0\ : STD_LOGIC;
begin
  indice_reg_1_sp_1 <= indice_reg_1_sn_1;
  indice_reg_2_sp_1 <= indice_reg_2_sn_1;
  ...
  \sec_generada[6]\(1 downto 0) <= \^sec_generada[6]\(1 downto 0);
  \sec_generada[7]\(0) <= \^sec_generada[7]\(0);
  \sec_generada[8]\(0) <= \^sec_generada[8]\(0);
  \sec_generada[9]\(0) <= \^sec_generada[9]\(0);
  \sec_generada_s_reg[0][1]_0\(1 downto 0) <= \^sec_generada_s_reg[0][1]_0\(1 downto 0);
  \sec_generada_s_reg[2][1]_0\ <= \^sec_generada_s_reg[2][1]_0\;
  \sec_generada_s_reg[3][1]_1\(1 downto 0) <= \^sec_generada_s_reg[3][1]_1\(1 downto 0);
  \sec_generada_s_reg[4][1]_0\(1 downto 0) <= \^sec_generada_s_reg[4][1]_0\(1 downto 0);
  \sec_generada_s_reg[5][1]_0\ <= \^sec_generada_s_reg[5][1]_0\;
  \sec_generada_s_reg[7][0]_0\ <= \^sec_generada_s_reg[7][0]_0\;
exito_prev_i_2: unisim.vcomponents.LUT6
    generic map(
      INIT => X"00000000FF1D0000"
    )
        port map (
      I0 => \^sec_generada_s_reg[2][1]_0\,
      I1 => Q(2),
      I2 => \^sec_generada_s_reg[5][1]_0\,
      I3 => Q(3),
      I4 => exito_prev_reg,
      I5 => \^sec_generada_s_reg[7][0]_0\,
      O => \sec_generada_s_reg[2][1]_1\
    );
exito_prev_i_3: unisim.vcomponents.LUT5
    generic map(
      INIT => X"AFC0A0C0"
    )
        port map (
...
exito_prev_i_4: unisim.vcomponents.LUT5
    generic map(
      INIT => X"AFC0A0C0"
    )
        port map (
...
fin_detectado_reg_i_10: unisim.vcomponents.LUT5
    generic map(
      INIT => X"AFC0A0C0"
    )
        port map (
...
fin_detectado_reg_i_12: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AFA0CFCFAFA0C0C0"
        ...
        port map (
      I0 => \^sec_generada_s_reg[3][1]_1\(0),
      I1 => \^sec_generada[2]\(0),
      I2 => indice_reg(1),
      I3 => \^sec_generada[1]\(0),
      I4 => indice_reg(0),
...
fin_detectado_reg_i_4: unisim.vcomponents.LUT4
    generic map(
      INIT => X"00E2"
    )
        port map (
      I0 => fin_detectado_reg_i_9_n_0,
      I1 => indice_reg(2),
      I2 => fin_detectado_reg_i_10_n_0,
      I3 => indice_reg(3),
      O => indice_reg_2_sn_1
    );
fin_detectado_reg_i_6: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8AAA"
    )
        port map (
      I0 => fin_detectado_reg_i_15_n_0,
      I1 => indice_reg(1),
      I2 => indice_reg(2),
      I3 => \^sec_generada[2]\(1),
      O => indice_reg_1_sn_1
...
fin_detectado_reg_i_7: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AFA0CFCFAFA0C0C0"
        ...
        port map (
      I0 => \^sec_generada_s_reg[3][1]_1\(1),
      I1 => \^sec_generada[2]\(1),
      I2 => indice_reg(1),
      I3 => \^sec_generada[1]\(1),
      I4 => indice_reg(0),
      I5 => \^sec_generada_s_reg[0][1]_0\(1),
      O => \sec_generada_s_reg[3][1]_2\
    );
...
\i_reg[3]_i_10\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AFA0CFCFAFA0C0C0"
    )
        port map (
...
\i_reg[3]_i_12\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFF440377CF"
    )
        port map (
      I0 => \^sec_generada[2]\(1),
      I1 => Q(1),
...
\i_reg[3]_i_14\: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => \^sec_generada[6]\(1),
      I5 => Q(2),
      O => \sec_generada_s_reg[8][1]_0\
    );
\i_reg[3]_i_15\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AFA0CFCFAFA0C0C0"
    )
        port map (
      ...
      I4 => Q(0),
      I5 => \^sec_generada_s_reg[0][1]_0\(1),
      O => \sec_generada_s_reg[3][1]_0\
    );
\i_reg[3]_i_16\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AFA0CFCFAFA0C0C0"
    )
        port map (
      ...
      I3 => \^sec_generada[5]\(1),
      I4 => Q(0),
      I5 => \^sec_generada_s_reg[4][1]_0\(1),
      O => \sec_generada_s_reg[5][2]_0\
    );
\i_reg[3]_i_6\: unisim.vcomponents.LUT6
    generic map(
      ...
      I0 => \i_reg[3]_i_9_n_0\,
      I1 => Q(2),
      I2 => \i_reg[3]_i_10_n_0\,
      I3 => Q(3),
      I4 => \i_reg[3]_i_4\,
      I5 => \i_reg[3]_i_12_n_0\,
...
\i_reg[3]_i_9\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => \^sec_generada[5]\(0),
      I4 => Q(0),
      I5 => \^sec_generada_s_reg[4][1]_0\(0),
      O => \i_reg[3]_i_9_n_0\
    );
...
\sec_actual_reg[1][1]_i_14\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"6FF6FFFFFFFF6FF6"
    )
        port map (
      I0 => \^sec_generada_s_reg[4][1]_0\(0),
      I1 => \sec_actual_reg[1][1]_i_7_0\(0),
      I2 => \^sec_generada_s_reg[4][1]_0\(1),
      I3 => \sec_actual_reg[1][1]_i_7_0\(1),
      I4 => \^sec_generada[2]\(1),
      I5 => \sec_actual_reg[1][1]_i_1_2\,
      O => \sec_actual_reg[1][1]_i_14_n_0\
    );
\sec_actual_reg[1][1]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"6FFFFF6FFFFFFFFF"
        ...
        port map (
      I0 => \^sec_generada[2]\(0),
      I1 => \sec_actual_reg[1][1]_i_1_6\(0),
      I2 => \sec_actual_reg[1][1]_i_1_7\,
      I3 => \sec_actual_reg[1][1]_i_1_6\(1),
      I4 => \^sec_generada[2]\(2),
      I5 => \sec_actual_reg[1][1]_i_9_n_0\,
      O => \sec_actual_reg[1][1]_i_2_n_0\
    );
\sec_actual_reg[1][1]_i_4\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9009000000009009"
    )
        port map (
...
\sec_actual_reg[1][1]_i_5\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"6FF6FFFFFFFF6FF6"
        ...
        port map (
      I0 => \^sec_generada[2]\(1),
      I1 => \sec_actual_reg[1][1]_i_1_2\,
      I2 => \^sec_generada_s_reg[0][1]_0\(0),
      I3 => \sec_actual_reg[1][1]_i_1_8\(0),
      I4 => \^sec_generada_s_reg[0][1]_0\(1),
      I5 => \sec_actual_reg[1][1]_i_1_8\(1),
...
\sec_actual_reg[1][1]_i_7\: unisim.vcomponents.LUT6
    generic map(
      ...
      I5 => \sec_actual_reg[1][1]_i_14_n_0\,
      O => \sec_actual_reg[1][1]_i_7_n_0\
    );
\sec_actual_reg[1][1]_i_9\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9009000000009009"
    )
        port map (
      I0 => \^sec_generada_s_reg[3][1]_1\(1),
      I1 => \sec_actual_reg[1][1]_i_2_0\(1),
      I2 => \sec_actual_reg[1][1]_i_1_2\,
      I3 => \^sec_generada[2]\(1),
      I4 => \sec_actual_reg[1][1]_i_2_0\(0),
      I5 => \^sec_generada_s_reg[3][1]_1\(0),
      O => \sec_actual_reg[1][1]_i_9_n_0\
    );
...
\sec_generada_s_reg[3][0]\: unisim.vcomponents.FDRE
    generic map(
      ...
      C => clk_BUFG,
      CE => \sec_generada_s_reg[8][1]_1\,
      D => \sec_generada_s_reg[3][1]_3\(0),
      Q => \^sec_generada_s_reg[3][1]_1\(0),
      R => '0'
    );
\sec_generada_s_reg[3][1]\: unisim.vcomponents.FDRE
    generic map(
      ...
      C => clk_BUFG,
      CE => \sec_generada_s_reg[8][1]_1\,
      D => \sec_generada_s_reg[3][1]_3\(1),
      Q => \^sec_generada_s_reg[3][1]_1\(1),
      R => '0'
    );
\sec_generada_s_reg[4][0]\: unisim.vcomponents.FDRE
    generic map(
      ...
      C => clk_BUFG,
      CE => \sec_generada_s_reg[8][1]_1\,
      D => \sec_generada_s_reg[4][1]_1\(0),
      Q => \^sec_generada_s_reg[4][1]_0\(0),
      R => '0'
    );
\sec_generada_s_reg[4][1]\: unisim.vcomponents.FDRE
    generic map(
      ...
      C => clk_BUFG,
      CE => \sec_generada_s_reg[8][1]_1\,
      D => \sec_generada_s_reg[4][1]_1\(1),
      Q => \^sec_generada_s_reg[4][1]_0\(1),
      R => '0'
    );
...
\sec_generada_s_reg[6][2]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\sec_generada_s_reg[8][1]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
entity controlador_nivel is
  port (
    ...
    \estado_actual_reg[1]_2\ : out STD_LOGIC_VECTOR ( 1 downto 0 );
    \estado_actual_reg[0]_1\ : out STD_LOGIC_VECTOR ( 1 downto 0 );
    \estado_actual_reg[2]_0\ : out STD_LOGIC_VECTOR ( 0 to 0 );
    \estado_actual_reg[1]_3\ : out STD_LOGIC;
    \estado_actual_reg[0]_2\ : out STD_LOGIC_VECTOR ( 1 downto 0 );
    \estado_actual_reg[0]_3\ : out STD_LOGIC;
    \estado_actual_reg[1]_4\ : out STD_LOGIC;
    \estado_actual_reg[0]_4\ : out STD_LOGIC;
    \estado_actual_reg[1]_5\ : out STD_LOGIC;
    exito_prev_reg_0 : in STD_LOGIC;
    clk_BUFG : in STD_LOGIC;
    error_prev_reg_0 : in STD_LOGIC;
...
architecture STRUCTURE of controlador_nivel is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \display[1]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \display[2]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \display[5]_i_1\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \display[6]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \estado_actual[0]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \estado_actual[1]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \estado_actual[2]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \sec_generada_s[0][0]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \sec_generada_s[0][1]_i_2\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \sec_generada_s[1][0]_i_1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \sec_generada_s[1][1]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \sec_generada_s[1][2]_i_1\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \sec_generada_s[2][0]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \sec_generada_s[2][1]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \sec_generada_s[2][2]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \sec_generada_s[3][0]_i_1\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \sec_generada_s[3][1]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \sec_generada_s[4][0]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \sec_generada_s[4][1]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \sec_generada_s[5][0]_i_1\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \sec_generada_s[5][1]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \sec_generada_s[5][2]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \sec_generada_s[6][1]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \sec_generada_s[6][2]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \sec_generada_s[7][0]_i_1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \sec_generada_s[9][1]_i_1\ : label is "soft_lutpair16";
begin
\display[1]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"36"
    )
        port map (
...
\display[5]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\display[6]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\sec_generada_s[6][1]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"38"
    )
        port map (
...
\sec_generada_s[6][2]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"04"
    )
        port map (
...
entity sync_3 is
  port (
    SYNC_OUT_reg_0 : out STD_LOGIC;
    clk_BUFG : in STD_LOGIC;
    \sec_generada_s_reg[8][1]\ : in STD_LOGIC;
    \sec_generada_s_reg[8][1]_0\ : in STD_LOGIC;
    D : in STD_LOGIC_VECTOR ( 0 to 0 )
  );
  attribute ORIG_REF_NAME : string;
...
\sec_generada_s[0][1]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"8A"
        ...
        port map (
      I0 => accion_listo,
      I1 => \sec_generada_s_reg[8][1]\,
      I2 => \sec_generada_s_reg[8][1]_0\,
      O => SYNC_OUT_reg_0
    );
\sreg_reg[0]\: unisim.vcomponents.FDRE
    generic map(
...
architecture STRUCTURE of TOP is
  ...
  signal inst_CompSecuencia_n_12 : STD_LOGIC;
  signal inst_CompSecuencia_n_13 : STD_LOGIC;
  ...
  signal inst_GenSecuencia_n_15 : STD_LOGIC;
  signal inst_GenSecuencia_n_18 : STD_LOGIC;
  signal inst_GenSecuencia_n_23 : STD_LOGIC;
  signal inst_GenSecuencia_n_24 : STD_LOGIC;
  ...
  signal \sec_generada[5]\ : STD_LOGIC_VECTOR ( 2 downto 0 );
  signal \sec_generada[6]\ : STD_LOGIC_VECTOR ( 2 downto 1 );
  signal \sec_generada[7]\ : STD_LOGIC_VECTOR ( 0 to 0 );
  signal \sec_generada[8]\ : STD_LOGIC_VECTOR ( 1 to 1 );
  signal \sec_generada[9]\ : STD_LOGIC_VECTOR ( 1 to 1 );
...
inst_CompSecuencia: entity work.CompSecuencia
     port map (
      ...
      SYNC_OUT_reg => inst_CompSecuencia_n_10,
      SYNC_OUT_reg_0 => inst_CompSecuencia_n_11,
      SYNC_OUT_reg_1 => inst_CompSecuencia_n_12,
      boton_listo_0 => boton_listo_0,
      boton_listo_1 => boton_listo_1,
      boton_listo_2 => boton_listo_2,
      boton_listo_3 => boton_listo_3,
      error_prev_i_2 => inst_GenSecuencia_n_24,
      error_prev_reg => inst_CompSecuencia_n_9,
      \estado_actual_reg[0]\(1 downto 0) => cur_state(1 downto 0),
      \estado_actual_reg[0]_0\ => inst_GenSecuencia_n_32,
      exito_prev_i_2 => inst_GenSecuencia_n_23,
      exito_prev_i_2_0 => inst_GenSecuencia_n_18,
      exito_prev_i_2_1 => inst_GenSecuencia_n_15,
      flag_boton => flag_boton,
      flag_boton_reg_i_1 => \inst_sync[4].botones_sync_n_1\,
      \i_reg[3]_0\ => inst_Controlador_de_Sec_n_10,
      \i_reg[3]_i_4_0\ => inst_GenSecuencia_n_25,
      \i_reg[3]_i_4_1\ => inst_GenSecuencia_n_26,
      \i_reg[3]_i_4_2\ => \inst_sync[1].botones_sync_n_1\,
      \p_0_in__0\(0) => \p_0_in__0\(0),
      \sec_actual_reg[1][1]_i_14\(1 downto 0) => \sec_generada[4]\(1 downto 0),
      \sec_actual_reg[1][1]_i_5\(1 downto 0) => \sec_generada[0]\(1 downto 0),
      \sec_actual_reg[1][1]_i_9\(1 downto 0) => \sec_generada[3]\(1 downto 0),
      \sec_generada[1]\(2 downto 0) => \sec_generada[1]\(2 downto 0),
      \sec_generada[2]\(2 downto 0) => \sec_generada[2]\(2 downto 0),
      \sec_generada[5]\(2 downto 0) => \sec_generada[5]\(2 downto 0),
      \sec_generada[6]\(1 downto 0) => \sec_generada[6]\(2 downto 1),
      \sec_generada[7]\(0) => \sec_generada[7]\(0),
      \sec_generada[8]\(0) => \sec_generada[8]\(1),
      \sec_generada[9]\(0) => \sec_generada[9]\(1),
      \sec_generada_s_reg[0][1]\(1) => inst_CompSecuencia_n_27,
      \sec_generada_s_reg[0][1]\(0) => inst_CompSecuencia_n_28,
      \sec_generada_s_reg[1][1]\(1) => inst_CompSecuencia_n_19,
      \sec_generada_s_reg[1][1]\(0) => inst_CompSecuencia_n_20,
      \sec_generada_s_reg[1][2]\ => inst_CompSecuencia_n_7,
      \sec_generada_s_reg[2][1]\ => inst_CompSecuencia_n_8,
      \sec_generada_s_reg[2][1]_0\ => inst_CompSecuencia_n_13,
      \sec_generada_s_reg[2][1]_1\ => inst_CompSecuencia_n_14,
      \sec_generada_s_reg[2][1]_2\ => inst_CompSecuencia_n_16,
      \sec_generada_s_reg[2][2]\(1) => inst_CompSecuencia_n_21,
      \sec_generada_s_reg[2][2]\(0) => inst_CompSecuencia_n_22,
      \sec_generada_s_reg[3][1]\(1) => inst_CompSecuencia_n_23,
      \sec_generada_s_reg[3][1]\(0) => inst_CompSecuencia_n_24,
      \sec_generada_s_reg[4][1]\(1) => inst_CompSecuencia_n_25,
      \sec_generada_s_reg[4][1]\(0) => inst_CompSecuencia_n_26,
      \sec_generada_s_reg[5][1]\ => inst_CompSecuencia_n_18,
      \sec_generada_s_reg[6][2]\ => inst_CompSecuencia_n_15,
      \sec_generada_s_reg[6][2]_0\ => inst_CompSecuencia_n_17,
      \sec_generada_s_reg[8][1]\ => inst_CompSecuencia_n_6,
      \sec_generada_s_reg[9][1]\ => inst_CompSecuencia_n_1
    );
inst_Controlador_de_Sec: entity work.Controlador_de_Sec
     port map (
      ...
      \cur_state_reg[0]_1\ => inst_Controlador_de_Sec_n_10,
      \cur_state_reg[0]_2\ => inst_Controlador_de_Sec_n_11,
      error_prev_reg => inst_Controlador_de_Sec_n_9,
      error_prev_reg_0 => inst_CompSecuencia_n_11,
      error_prev_reg_1 => inst_CompSecuencia_n_10,
      exito_prev_reg => inst_Controlador_de_Sec_n_6,
      exito_prev_reg_0 => inst_GenSecuencia_n_32,
      fin_detectado_reg_i_3_0(1 downto 0) => \sec_generada[4]\(1 downto 0),
      fin_tiempo => fin_tiempo,
      indice_reg(3 downto 0) => indice_reg(3 downto 0),
      \indice_reg[3]_0\ => inst_GenSecuencia_n_27,
      \led_reg[3]\ => inst_GenSecuencia_n_30,
      \led_reg[3]_0\ => inst_GenSecuencia_n_28,
      \led_reg[3]_1\ => inst_GenSecuencia_n_29,
      p_0_in(0) => p_0_in(0),
      \p_0_in__0\(0) => \p_0_in__0\(0),
      pedir_tiempo_reg_P_0 => inst_Controlador_de_Sec_n_1,
      \sec_generada[1]\(0) => \sec_generada[1]\(2),
...
inst_GenSecuencia: entity work.GenSecuencia
     port map (
      ...
      D(1) => inst_controlador_nivel_n_5,
      D(0) => inst_controlador_nivel_n_8,
      E(0) => inst_GenSecuencia_n_31,
      Q(3 downto 0) => i(3 downto 0),
      clk_BUFG => clk_BUFG,
      exito_prev_reg => inst_CompSecuencia_n_13,
      \i_reg[3]_i_2\ => inst_CompSecuencia_n_17,
      \i_reg[3]_i_2_0\ => inst_CompSecuencia_n_15,
      \i_reg[3]_i_4\ => inst_CompSecuencia_n_14,
      indice_reg(3 downto 0) => indice_reg(3 downto 0),
      indice_reg_1_sp_1 => inst_GenSecuencia_n_28,
      indice_reg_2_sp_1 => inst_GenSecuencia_n_27,
      \sec_actual_reg[1][1]_i_1_0\(1) => inst_CompSecuencia_n_19,
      \sec_actual_reg[1][1]_i_1_0\(0) => inst_CompSecuencia_n_20,
      \sec_actual_reg[1][1]_i_1_1\ => inst_CompSecuencia_n_7,
      \sec_actual_reg[1][1]_i_1_2\ => inst_CompSecuencia_n_8,
      \sec_actual_reg[1][1]_i_1_3\ => inst_CompSecuencia_n_6,
      \sec_actual_reg[1][1]_i_1_4\ => inst_CompSecuencia_n_1,
      \sec_actual_reg[1][1]_i_1_5\ => inst_CompSecuencia_n_18,
      \sec_actual_reg[1][1]_i_1_6\(1) => inst_CompSecuencia_n_21,
      \sec_actual_reg[1][1]_i_1_6\(0) => inst_CompSecuencia_n_22,
      \sec_actual_reg[1][1]_i_1_7\ => inst_CompSecuencia_n_16,
      \sec_actual_reg[1][1]_i_1_8\(1) => inst_CompSecuencia_n_27,
      \sec_actual_reg[1][1]_i_1_8\(0) => inst_CompSecuencia_n_28,
      \sec_actual_reg[1][1]_i_2_0\(1) => inst_CompSecuencia_n_23,
      \sec_actual_reg[1][1]_i_2_0\(0) => inst_CompSecuencia_n_24,
      \sec_actual_reg[1][1]_i_7_0\(1) => inst_CompSecuencia_n_25,
      \sec_actual_reg[1][1]_i_7_0\(0) => inst_CompSecuencia_n_26,
      \sec_generada[1]\(2 downto 0) => \sec_generada[1]\(2 downto 0),
      \sec_generada[2]\(2 downto 0) => \sec_generada[2]\(2 downto 0),
      \sec_generada[5]\(2 downto 0) => \sec_generada[5]\(2 downto 0),
      \sec_generada[6]\(1 downto 0) => \sec_generada[6]\(2 downto 1),
      ...
      \sec_generada[8]\(0) => \sec_generada[8]\(1),
      \sec_generada[9]\(0) => \sec_generada[9]\(1),
      \sec_generada_s_reg[0][0]_0\(0) => inst_controlador_nivel_n_17,
      \sec_generada_s_reg[0][1]_0\(1 downto 0) => \sec_generada[0]\(1 downto 0),
      \sec_generada_s_reg[1][1]_0\(1) => inst_controlador_nivel_n_15,
      \sec_generada_s_reg[1][1]_0\(0) => inst_controlador_nivel_n_16,
      \sec_generada_s_reg[1][2]_0\ => inst_controlador_nivel_n_22,
      \sec_generada_s_reg[2][1]_0\ => inst_GenSecuencia_n_26,
      \sec_generada_s_reg[2][1]_1\ => inst_GenSecuencia_n_32,
      \sec_generada_s_reg[2][1]_2\ => inst_controlador_nivel_n_24,
      \sec_generada_s_reg[2][2]_0\(1) => inst_controlador_nivel_n_19,
      \sec_generada_s_reg[2][2]_0\(0) => inst_controlador_nivel_n_20,
      \sec_generada_s_reg[3][0]_0\ => inst_GenSecuencia_n_30,
      \sec_generada_s_reg[3][1]_0\ => inst_GenSecuencia_n_18,
      \sec_generada_s_reg[3][1]_1\(1 downto 0) => \sec_generada[3]\(1 downto 0),
      \sec_generada_s_reg[3][1]_2\ => inst_GenSecuencia_n_29,
      \sec_generada_s_reg[3][1]_3\(1) => inst_controlador_nivel_n_11,
      \sec_generada_s_reg[3][1]_3\(0) => inst_controlador_nivel_n_12,
      \sec_generada_s_reg[4][1]_0\(1 downto 0) => \sec_generada[4]\(1 downto 0),
      \sec_generada_s_reg[4][1]_1\(1) => inst_controlador_nivel_n_13,
      \sec_generada_s_reg[4][1]_1\(0) => inst_controlador_nivel_n_14,
      \sec_generada_s_reg[5][0]_0\ => inst_controlador_nivel_n_23,
      \sec_generada_s_reg[5][1]_0\ => inst_GenSecuencia_n_25,
      \sec_generada_s_reg[5][1]_1\ => inst_controlador_nivel_n_10,
      \sec_generada_s_reg[5][2]_0\ => inst_GenSecuencia_n_15,
      \sec_generada_s_reg[5][2]_1\ => inst_controlador_nivel_n_9,
      \sec_generada_s_reg[6][2]_0\ => inst_controlador_nivel_n_18,
      \sec_generada_s_reg[7][0]_0\ => inst_GenSecuencia_n_24,
      \sec_generada_s_reg[8][1]_0\ => inst_GenSecuencia_n_23,
      \sec_generada_s_reg[8][1]_1\ => inst_sync_accion_n_0,
      \sec_generada_s_reg[9][1]_0\ => inst_controlador_nivel_n_21,
      sec_lista => sec_lista
    );
inst_controlador_nivel: entity work.controlador_nivel
     port map (
      ...
      D(0) => inst_controlador_nivel_n_8,
      clk_BUFG => clk_BUFG,
      error_prev_reg_0 => inst_Controlador_de_Sec_n_9,
      \estado_actual_reg[0]_0\(1) => inst_controlador_nivel_n_11,
      \estado_actual_reg[0]_0\(0) => inst_controlador_nivel_n_12,
      \estado_actual_reg[0]_1\(1) => inst_controlador_nivel_n_15,
      \estado_actual_reg[0]_1\(0) => inst_controlador_nivel_n_16,
      \estado_actual_reg[0]_2\(1) => inst_controlador_nivel_n_19,
      \estado_actual_reg[0]_2\(0) => inst_controlador_nivel_n_20,
      \estado_actual_reg[0]_3\ => inst_controlador_nivel_n_21,
      \estado_actual_reg[0]_4\ => inst_controlador_nivel_n_23,
      \estado_actual_reg[0]_5\ => inst_CompSecuencia_n_9,
      ...
      \estado_actual_reg[1]_2\(1) => inst_controlador_nivel_n_13,
      \estado_actual_reg[1]_2\(0) => inst_controlador_nivel_n_14,
      \estado_actual_reg[1]_3\ => inst_controlador_nivel_n_18,
      \estado_actual_reg[1]_4\ => inst_controlador_nivel_n_22,
      \estado_actual_reg[1]_5\ => inst_controlador_nivel_n_24,
      \estado_actual_reg[2]_0\(0) => inst_controlador_nivel_n_17,
      exito_prev_reg_0 => inst_Controlador_de_Sec_n_11,
      p_0_in(0) => p_0_in(0),
      \p_0_in__0\(0) => \p_0_in__0\(0)
    );
...
inst_sync_accion: entity work.sync_3
     port map (
      ...
      clk_BUFG => clk_BUFG,
      \sec_generada_s_reg[8][1]\ => inst_Controlador_de_Sec_n_10,
      \sec_generada_s_reg[8][1]_0\ => inst_CompSecuencia_n_12
    );
